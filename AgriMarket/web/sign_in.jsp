            ...
            function loginCallBack(responseTxt, statusTxt, xhr) {
                if (statusTxt == "success") {
                    if (responseTxt == "success") {
                        ...
                        $("#error").html("Wrong mail or password");
                }
            }
        </script>
    </head>
                            ...
                            <div class="col-sm-8 col-sm-offset-2">
                                <form action="signin" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="email" id="mail" class="form-control" name="email" required="" placeholder="Email*">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="mbr-buttons mbr-buttons--right">
                                        ...
                                        <button type="button" onclick="signIn()"  class="mbr-buttons__btn btn btn-lg btn-danger">SIGN IN</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
