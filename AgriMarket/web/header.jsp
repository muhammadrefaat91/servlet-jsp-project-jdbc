                                ...
                                <c:if test="${!empty sessionScope.user}">
                                    ...
                                    <li class="mbr-navbar__item">
                                        <div class="shopping-item" style="margin-top: 0px; margin-left:35px;">
                                            <a href="cart.jsp">Cart - <span class="cart-amunt" id="total">$</span> <i class="fa fa-shopping-cart"></i> <span class="product-count" id="itemNo"></span></a>
                                        </div>
                                    </li>
                                    
                                    <li class="mbr-navbar__item">
                                    <a  id="asignin" class="mbr-buttons__btn btn btn-default"  href="LogOut">
                                        <p id="signin">Log Out</p></a>
